...
int fakemain(int argc, char **argv)
{
    ...
    // LOGI("register avcodec");
#if CONFIG_AVDEVICE
    avdevice_register_all();
    // LOGI("register avdevice");
#endif
    avfilter_register_all();
    // LOGI("register avfilter");
    av_register_all();
    // LOGI("register all");
...
void * execute_ffmpeg(void * cmd)
{
    ...
    // LOGI("call fakemain");
    return_code = 0;
    return_code = fakemain(argc, argv);
    pthread_exit(NULL);
}
//Changed by ED  END
